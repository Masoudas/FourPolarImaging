...
public class FoVCalculatorFourCameraTest {
    @Test
    public void calculate_FoVsInsideImageDim_ReturnsSameFoV() {
        ...
        FoVCalculatorFourCamera calculator = new FoVCalculatorFourCamera(metadata1, metadata2, metadata3, metadata4);

        ShapeFactory shapeFactory = new ShapeFactory();
        IBoxShape pol0 = shapeFactory.closedBox(new long[] { 0, 0 }, new long[] { 4, 4 }, AxisOrder.XY);
        IBoxShape pol45 = shapeFactory.closedBox(new long[] { 0, 0 }, new long[] { 4, 4 }, AxisOrder.XY);
        IBoxShape pol90 = shapeFactory.closedBox(new long[] { 0, 0 }, new long[] { 4, 4 }, AxisOrder.XY);
        IBoxShape pol135 = shapeFactory.closedBox(new long[] { 0, 0 }, new long[] { 4, 4 }, AxisOrder.XY);
