...
public class FourCameraPolararizationImageSetCreator extends PolarizationImageSetCreator {
    public FourCameraPolararizationImageSetCreator(IFieldOfView fov, int numChannels) {
    ...
    public void setCapturedImageSet(ICapturedImageSet capturedImageSet) {
        ...
        this._pol0 = this._segmenter.segment(capturedImages_pol0, pol0FoV);

        IBoxShape pol45FoV = this._fov.getFoV(Polarization.pol45);
        this._pol45 = this._segmenter.segment(capturedImages_pol45, pol45FoV);

        IBoxShape pol90FoV = this._fov.getFoV(Polarization.pol90);
        this._pol90 = this._segmenter.segment(capturedImages_pol90, pol90FoV);

        IBoxShape pol135FoV = this._fov.getFoV(Polarization.pol135);
        this._pol135 = this._segmenter.segment(capturedImages_pol135, pol135FoV);
