...
public interface ICapturedImageReader {
     ...
     * @param fileSet
     * @param fileLabel : The file label of the image to be read. Should be from {@link Cameras} 
     * @return
     * @throws IllegalArgumentException : thrown in case the given fileLabel is not in the file set.
     * @throws IOException : In case of file IO issues.
     */
    public ICapturedImage read(ICapturedImageFileSet fileSet, String fileLabel) throws IllegalArgumentException, IOException;
