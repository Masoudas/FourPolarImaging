...
public class FilterCapturedImagesTest {
    private static File _root = new File(FilterCapturedImagesTest.class.getResource("FilterCapturedImages").getPath());
 
    @Test
    public void testFilter_OneCameraCase_ReturnsTwoFiles() {    
        File oneCameraRoot = new File(_root, "OneCamera");
        FilterCapturedImage filterImage = new FilterCapturedImage(null, "C2");
    ...
    public void testFilter_TwoCamerCase_ReturnsFourFiles() {
        ...
        FilterCapturedImage filterImage = new FilterCapturedImage("Pol0_90", "C1");
    ...
    public void testFilter_FourCamerCase_ReturnsFourFiles() {
        ...
        FilterCapturedImage filterImage = new FilterCapturedImage("Pol0", "C1");
