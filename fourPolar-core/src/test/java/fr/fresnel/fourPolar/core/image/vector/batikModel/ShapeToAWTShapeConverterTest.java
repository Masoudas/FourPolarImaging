...
public class ShapeToAWTShapeConverterTest {
    @Test
    public void convertPoint_Convert1DPoint_ThrowsIllegalArgumentException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> ShapeToAWTShapeConverter.convertPoint(pointShape));
    }
    ...
    public void convertPoint_Convert2DPoint_CreatesCorrectPointShape() {
        ...
        Point point = ShapeToAWTShapeConverter.convertPoint(pointShape);
    ...
    public void convertLine_Convert1DLine_ThrowsIllegalArgumentException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> ShapeToAWTShapeConverter.convertLine(lineShape));
    }
    ...
    public void convertLine_Convert2DLineFromOriginTo22_CreatesCorrect2DLine() {
        ...
        Line2D line = ShapeToAWTShapeConverter.convertLine(lineShape);
    ...
    public void convertBox_Convert2DBoxFromOriginTo11_ReturnsCorrectBox() {
        ...
        Rectangle rectangle = ShapeToAWTShapeConverter.convertBox(boxShape);
